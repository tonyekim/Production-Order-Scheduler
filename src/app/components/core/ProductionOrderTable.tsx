...
//               <DropdownMenuItem className="text-white" onClick={() => navigator.clipboard.writeText(order.id)}>
//                 Copy Order ID
//               </DropdownMenuItem>
//               <DropdownMenuSeparator />
//               {order.status === "Pending" && (
//                 <DropdownMenuItem className="text-white" onClick={() => handleOpenEditForm(order)}>
//                   <Edit2 className="mr-2 h-4 w-4 text-white" /> Edit / Schedule
//                 </DropdownMenuItem>
//               )}
//               {order.status === "Scheduled" && (
//                 <DropdownMenuItem className="text-white" onClick={() => handleOpenEditForm(order)}>
//                   <Edit2 className="mr-2 h-4 w-4 text-white" /> <span className="text-white">Edit Schedule</span> 
//                 </DropdownMenuItem>
//               )}
//             </DropdownMenuContent>
//           </DropdownMenu>
...
//       data: Array.isArray(productionOrders) ? productionOrders : [],
//     columns,
...
import { ArrowUpDown, MoreHorizontal, Edit2, PlusCircle, Trash2 } from "lucide-react";
import { Button } from "@/components/ui/button";
import {
  DropdownMenu,
  DropdownMenuContent,
  ...
  const columns: ColumnDef<ProductionOrder>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return startTime
          ? format(new Date(startTime), "yyyy-MM-dd HH:mm")
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return endTime
          ? format(new Date(endTime), "yyyy-MM-dd HH:mm")
          : <span className="text-muted-foreground">N/A</span>;
      },
    },
    {
        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="bg-black">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem className="text-white" onClick={() => handleOpenEditForm(order)}>
                <Edit2 className="mr-2 h-4 w-4 text-white" /> Edit Order
              </DropdownMenuItem>
              <DropdownMenuItem
              ...
              >
                <Trash2 className="mr-2 h-4 w-4 text-white" /> Delete Order
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        );
